    ...
    <div className='bg-[#F4F4F4]'>
      ...
      <div className='header relative'>
        <div className='h-[75px] bg-center' 
            style={{'background-image': "url('/images/Union.png')", 
              'background-size' : '200% 100%', transform: 'scaleY(-1)'}}>
        </div>
        <div className='pt-16 px-20'>
          <div></div>
          <div className='grid grid-cols-2 max-[1100px]:grid-cols-1 max-[1100px]:gap-y-2'>
            <div className='flex flex-col  text-[#344054] font-bold text-[64px] 
              max-[1440px]:text-[50px] max-[1100px]:items-center'>
              <span>Atlas Premier</span>
              <span>Knowledge Blogs:</span>
            </div>
            <div className='text-[#667085] font-medium leading-10 flex flex-col justify-center 
              text-[24px] max-[1440px]:text-[22px] max-[1100px]:items-center'>
              <span>"Immerse yourself in the latest knowledge</span>
              <p>and research from our team of</p> 
              <p>software engineers and design professionals.</p>
            </div>
            <div>
          ...
          <div className='grid grid-cols-2 max-[1100px]:grid-cols-1 rounded-[40px] bg-white p-2'>
            <div className=''>
              <img src = '/images/MacBook.png' alt='' className='rounded-l-[35px] h-[488px] w-full'/> 
            </div>
            <div className='bg-[#F4F4F4] rounded-lg rounded-r-[35px] flex flex-col justify-center pl-16 
              ...
              <div className='flex flex-col font-medium gap-y-[10px] mt-[15px] 
                text-[40px] max-[1440px]:text-[35px]'>
                <span>07 Ways to get</span>
                <span>Consistent Clients from</span>
                <span>Social Media</span>
              </div>
              <div className='pt-32 text-[#475467] font-medium flex gap-x-5 items-center
                text-[20px] max-[1440px]:text-[18px]'>
        ...
        <div className='h-[75px] bg-center' 
            style={{'background-image': "url('/images/Union.png')", 'background-size' : '200% 100%'}}>
        </div>
      </div>
      ...
      <div className='blog-section p-20'>
        ...
        <div className='bg-gradient-to-b from-[#2F5478] to-[#22405C] rounded-[40px] mt-20'>
          <div className='h-[75px] bg-center' 
            style={{'background-image': "url('/images/Union.png')", 'background-size' : '200% 100%', 'transform': 'scaleY(-1)'}}>
          </div>
